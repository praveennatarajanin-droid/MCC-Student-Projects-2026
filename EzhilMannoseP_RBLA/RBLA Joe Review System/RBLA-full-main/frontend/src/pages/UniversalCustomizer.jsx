...
export default function UniversalCustomizer({ category }) {
  ...
  const handleDownload = () => {
    ...
    toast.info("Generating high-resolution preview...", { autoClose: 1500 });
          ...
          fetch("http://localhost:5000/designs", {
            ...
            .then((data) => {
              if (data.design) {
                ...
                toast.success("Design saved to your account!", { autoClose: 3000 });
              } else {
    ...
    <div className="universal-customizer-wrapper">
      <div className="customizer-container">
        ...
        <div className="customizer-panel right-panel">
          <div className="panel-section">
            <h4>💾 Export Design</h4>
            <button className="primary-action-btn" onClick={handleDownload}>
              💾 Save & Download PNG
            </button>
          </div>
