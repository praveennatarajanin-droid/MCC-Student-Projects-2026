...
// Get all products (with sentiment analysis, paginated)
exports.getAllProducts = async (req, res, next) => {
    try {
        const { category, isActive, store, page = 1, limit = 1000 } = req.query;
        console.log('Query params:', { category, isActive, store, page, limit });
        ...
        // Fetch paged products with sentiment
        const products = await getAllProductsWithSentiment(filter, Number(page), Number(limit));
