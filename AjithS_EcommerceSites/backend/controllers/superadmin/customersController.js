...
exports.filterCustomersByStore = catchAsync(async (req, res, next) => {
    ...
    if (!['enterprises1', 'enterprises3', 'enterprises2'].includes(store)) {
        return next(new AppError('Invalid store. Must be one of: enterprises1, enterprises3, enterprises2', 400));
    }
