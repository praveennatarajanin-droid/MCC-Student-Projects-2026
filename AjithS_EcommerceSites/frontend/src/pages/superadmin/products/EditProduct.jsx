...
const getFullImageUrl = (url) => url ? (url.startsWith('http') ? url : `${backendBaseUrl}${url}`) : '';
...
const EditProduct = ({ product, onBack }) => {
    ...
    const handleImageUpload = async (e) => {
        ...
        const allowedTypes = [
            ...
            'image/gif', 'image/bmp', 'image/tiff', 'image/svg+xml', 'image/avif',
            'image/x-icon', 'image/heic', 'image/heif'
        ];
        if (!allowedTypes.includes(file.type)) {
            setError('Please upload a valid image file (JPEG, PNG, GIF, WebP, BMP, TIFF, SVG, HEIC)');
            return;
        }
                    ...
                    <div className="image-upload-container">
                        {formData.image_url ? (
                            <div className="image-preview">
                                <img src={getFullImageUrl(formData.image_url)} alt="Product preview" />
                                <button
                                    type="button"
