          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth required variant="outlined">
                ...
                >
                  <MenuItem value="enterprises1">Enterprises1</MenuItem>
                  <MenuItem value="enterprises2">Enterprises2</MenuItem>
                  <MenuItem value="enterprises3">Enterprises3</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={12} md={6}>
                    ...
                    <TableRow key={worker._id}>
                      ...
                      <TableCell>
                        <Chip
                          label={worker.store}
                          color={
                            worker.store.toLowerCase() === 'enterprises1'
                              ? 'primary'
                              : worker.store.toLowerCase() === 'enterprises3'
                              ? 'success'
                              : 'warning'
                          }
                          size="small"
