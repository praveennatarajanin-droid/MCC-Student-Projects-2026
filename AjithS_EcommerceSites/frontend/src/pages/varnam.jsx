...
import "./varnam.css";
import enterprises1logo from "../components/Assets/enterprises1logo.png"; // Enterprises1 logo
    ...
    <div className="varnam-page">
      ...
      <header className="varnam-header" style={{ backgroundImage: `url(${v6})` }}>
        <div className="header-overlay">
          <img src={enterprises1logo} alt="Enterprises1 Logo" className="varnam-logo" />
          <h1>Varnam Unit</h1>
