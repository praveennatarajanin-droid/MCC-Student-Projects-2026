...
const LoginSignup = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === 'email') {
      ...
      setValidationErrors(prev => ({
        ...prev,
        password: isLogin ? validateLoginPassword(value) : validatePassword(value)
      }));
  ...
  return (
    <div className="auth-container">
      <div className="auth-box">
        ...
        <div className="admin-portal-link-container" style={{ textAlign: 'center', margin: '15px 0' }}>
          <Link to="/UserLogin" style={{ color: '#0056b3', textDecoration: 'underline', fontWeight: '500', fontSize: '14px' }}>
            Are you an Admin or Superadmin? Access Portal Here
          </Link>
        </div>
