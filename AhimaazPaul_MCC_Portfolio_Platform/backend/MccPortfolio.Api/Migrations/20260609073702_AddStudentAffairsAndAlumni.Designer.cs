...
namespace MccPortfolio.Api.Migrations
{
    ...
    [Migration("20260609073702_AddStudentAffairsAndAlumni")]
    partial class AddStudentAffairsAndAlumni
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MccPortfolio.Api.Entities.AlumniRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MccPortfolio.Api.Entities.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MccPortfolio.Api.Entities.Grievance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MccPortfolio.Api.Entities.Announcement", b =>
                {
                    b.HasOne("MccPortfolio.Api.Entities.User", "CreatedBy")
                        .WithMany()
